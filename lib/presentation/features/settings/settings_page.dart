        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (_) => const _AccountManagerPage()),
            ),
          ),
...
class _AccountManagerPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_AccountManagerPage> createState() =>
      _AccountManagerPageState();
}

class _AccountManagerPageState extends ConsumerState<_AccountManagerPage> {
