...
class AccountDeltaDto {
  ...
  factory AccountDeltaDto.fromEntity(dynamic a, SyncDeltaType t, DateTime now) {
    ...
    return AccountDeltaDto._(
      ...
      isDefault: (a.isDefault as bool? ?? 0) == true,
      status: a.status as String?,
      balance: a.balance as int?,
      balancePrev: a.balancePrev as int?,
      balanceBlocked: a.balanceBlocked as int?,
      balanceInit: a.balanceInit as int?,
      balanceGoal: a.balanceGoal as int?,
